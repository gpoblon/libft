...
/*   Updated: 2018/04/19 10:41:44 by gwojda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mult_matrix3f(t_fmat3 mat1, t_fmat3 mat2)
{
	...
	mat1[1] = (tmp[0] * mat2[1]) + (tmp[1] * mat2[4]) + (tmp[2] * mat2[7]);
	mat1[2] = (tmp[0] * mat2[2]) + (tmp[1] * mat2[5]) + (tmp[2] * mat2[8]);
	mat1[3] = (tmp[3] * mat2[0]) + (tmp[4] * mat2[3]) + (tmp[5] * mat2[6]);
	mat1[4] = (tmp[3] * mat2[1]) + (tmp[4] * mat2[4]) + (tmp[5] * mat2[7]);
	mat1[5] = (tmp[3] * mat2[2]) + (tmp[4] * mat2[5]) + (tmp[5] * mat2[8]);
	mat1[6] = (tmp[6] * mat2[0]) + (tmp[7] * mat2[1]) + (tmp[8] * mat2[2]);
	mat1[7] = (tmp[6] * mat2[3]) + (tmp[7] * mat2[4]) + (tmp[8] * mat2[5]);
	mat1[8] = (tmp[6] * mat2[6]) + (tmp[7] * mat2[7]) + (tmp[8] * mat2[8]);
}
