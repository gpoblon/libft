...
/*   Updated: 2018/04/19 10:37:58 by gwojda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef double	t_dmat4[16];
typedef double	t_dmat3[9];
typedef double	t_dmat2[4];

typedef double	t_dvect4[4];
typedef double	t_dvect3[3];
typedef double	t_dvect2[2];
